import { Droplet, Syringe, Pill, Leaf, CircleDot, Hand, Wind, ArrowDown, Atom, Zap, HeartPulse, Sparkles, Waves } from "lucide-react";
const SECTIONS = [
...
const TIME_OF_DAY = ["утро", "обед", "вечер", "перед сном", "натощак", "после еды", "в любое время"];
const DILUTION_VOLUMES = [100, 200, 250, 400, 500];
const SOLVENTS = ["0.9% NaCl", "5% глюкоза", "вода для инъекций", "Рингер", "готовый раствор"];
export {
  DILUTION_VOLUMES as D,
  FREQUENCY_PRESETS as F,
  SECTION_MAP as S,
  TIME_OF_DAY as T,
  SECTIONS as a,
  SOLVENTS as b
