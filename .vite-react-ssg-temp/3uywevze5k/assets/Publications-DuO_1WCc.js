...
import { ExternalLink, FileText, BookOpen, Award, Microscope } from "lucide-react";
import "react";
...
const publications = [
  ...
  { n: 41, title: "Операция Murmur в собственной оригинальной модификации у детей. 8 лет опыта", authors: "Тарусин Д.И., Жидков М.В., Тарусин В.Д., Горкин С.А., Андреева Т.Е.", source: "VII Всероссийская Школа по детской урологии-андрологии. Тезисы. — М., 2018", year: "2018", url: "https://uroweb.ru/sites/default/files/tezisi-det-shkola-2018.pdf" },
  { n: 42, title: "Сонографические критерии венозной недостаточности при левостороннем варикоцеле у детей", authors: "Тарусин Д.И., Жидков М.В., Тарусин В.Д., Горкин С.А., Андреева Т.Е.", source: "VII Всероссийская Школа по детской урологии-андрологии. Тезисы. — М., 2018", year: "2018", url: "https://uroweb.ru/sites/default/files/tezisi-det-shkola-2018.pdf" },
  ...
  { n: 54, title: "Хирургический дневной стационар детской многопрофильной больницы", authors: "Корочкин М.В., Кравчук С.В., Поддубный Г.С., Сумарокова Е.В., Тарусин Д.И.", source: "Проблемы социальной гигиены. — 2019. — PMID: 31747150", year: "2019", url: "https://pubmed.ncbi.nlm.nih.gov/31747150/" },
  ...
  { n: 65, title: "Группировка исходов оперативного лечения варикоцеле", authors: "Тарусин Д.И., Матар А.А., Ефремов Е.А. и др.", source: "X Юбилейная Всероссийская Школа. Тезисы. — М., 2022. — С. 67", year: "2022", url: "https://uroweb.ru/sites/default/files/TEZIS_2022.pdf" },
  { n: 66, title: "Топическая диагностика венозной недостаточности в системе оттока от левого яичка у детей и подростков", authors: "Тарусин Д.И., Матар А.А. и др.", source: "X Юбилейная Всероссийская Школа. Тезисы. — М., 2022. — С. 70", year: "2022", url: "https://uroweb.ru/sites/default/files/TEZIS_2022.pdf" },
  { n: 67, title: "Гидролимфоцеле. Памяти профессора А.П. Ерохина", authors: "Тарусин Д.И., Жидков М.В., Матар А.А. и др.", source: "XI Всероссийская Школа. Тезисы. — М., 2023", year: "2023", url: "https://uroweb.ru/sites/default/files/TEZIS_det_shkola_2023.pdf" },
  ...
  { n: 73, title: "Простатопатия у пациентов с варикоцеле — миф или реальность?", authors: "Тарусин Д.И., Жидков М.В., Матар А.А. и др.", source: "XI Всероссийская Школа. Тезисы. — М., 2023", year: "2023", url: "https://uroweb.ru/sites/default/files/TEZIS_det_shkola_2023.pdf" },
  ...
  { n: 79, title: "Современные методы диагностики и лечения сосудистых аномалий урогенитальной области у детей и взрослых", authors: "Тарусин Д.И., Матар А.А., Сафин Д.А., Жуков О.Б.", source: "10-я Школа АСУР. — Севастополь, 2023", year: "2023", url: "https://uroweb.ru/sites/default/files/programma_asur.pdf" },
...
const Publications = () => {
  ...
  const sortedDecades = Object.keys(groupedPublications).sort(
    (a, b) => parseInt(b) - parseInt(a)
  );
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsx(PageMeta, { title: isEn ? "Scientific Publications — Prof. Tarusin" : "Научные публикации — Проф. Тарусин Д.И.", description: isEn ? "Complete list of Professor Tarusin's scientific works: 89 publications, 6 national guidelines chapters, doctoral dissertation." : "Полный список научных работ профессора Тарусина Д.И.: 89 публикаций, 6 глав в национальных руководствах, докторская диссертация.", path: "/publications" }),
    /* @__PURE__ */ jsx(
      JsonLd,
      {
        data: {
    ...
    /* @__PURE__ */ jsx(Header, {}),
    /* @__PURE__ */ jsxs("main", { className: "pt-20 md:pt-24", children: [
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24 bg-gradient-to-br from-secondary/50 to-background", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-4xl md:text-5xl font-bold text-foreground mb-6", children: isEn ? "Scientific Publications" : "Научные публикации" }),
        /* @__PURE__ */ jsx("p", { className: "text-lg md:text-xl text-muted-foreground mb-12", children: isEn ? "Complete list of my scientific works, including peer-reviewed journal articles, national guideline chapters, doctoral dissertation, and video presentations" : "Полный список моих научных работ, включая статьи в рецензируемых журналах, главы в национальных руководствах, докторскую диссертацию и видеодоклады" }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-6", children: stats.map((stat, index) => /* @__PURE__ */ jsx(Card, { className: "bg-card/50 backdrop-blur-sm border-border/50", children: /* @__PURE__ */ jsxs(CardContent, { className: "p-6 text-center", children: [
          /* @__PURE__ */ jsx(stat.icon, { className: "w-8 h-8 mx-auto mb-3 text-primary" }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsx("div", { className: "max-w-4xl mx-auto", children: sortedDecades.map((decade) => /* @__PURE__ */ jsxs("div", { className: "mb-12", children: [
        /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-bold text-foreground mb-6 flex items-center gap-3", children: [
          /* @__PURE__ */ jsx("span", { className: "bg-primary text-primary-foreground px-4 py-2 rounded-lg", children: decade }),
          /* @__PURE__ */ jsxs("span", { className: "text-muted-foreground text-base font-normal", children: [
            "(",
            groupedPublications[decade].length,
            " ",
            isEn ? "publications" : "публикаций",
            ")"
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "space-y-3", children: groupedPublications[decade].map((pub) => /* @__PURE__ */ jsx(
          Card,
          {
            className: "bg-card hover:bg-secondary/50 transition-colors border-border/50",
            children: /* @__PURE__ */ jsx(CardContent, { className: "p-4 md:p-5", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
              /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 w-14 text-sm font-medium text-primary bg-primary/10 px-2 py-1 rounded text-center", children: pub.year }),
              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsx("p", { className: "text-foreground font-medium leading-relaxed mb-1", children: pub.title }),
                /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground mb-1", children: pub.authors }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground/70", children: pub.source }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-8 bg-secondary/30", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsx("p", { className: "text-center text-sm text-muted-foreground", children: isEn ? "Compiled from open sources: PubMed, Uro.TV, UroWeb.ru, CyberLeninka.ru, eLibrary.ru, Google Scholar" : "Составлено с использованием открытых источников: PubMed, Uro.TV, UroWeb.ru, CyberLeninka.ru, eLibrary.ru, Google Scholar" }) }) })
    ] }),
    /* @__PURE__ */ jsx(Footer, {})
  ] });
};
