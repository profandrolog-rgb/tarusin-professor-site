...
/**
 * Omega9MufaSVG — статическая SVG-карточка «Омега-9 МНЖК» (omega9_mufa).
...
<text class="ttl" x="30" y="40">Омега-9 МНЖК</text>
<text class="sub" x="30" y="60">omega9_mufa · связи по слою зависимостей · М=моча К=кровь · severity не начисляется</text>
<line class="ar" data-edge-id="DEP_067" data-from="oleic" data-to="mead" data-direction="→" data-relation="реакция" x1="504.0" y1="180.0" x2="776.0" y2="180.0" marker-end="url(#__ARROW_ID__)"/>
<g><rect class="cyc" data-node-id="hexadecenoic_n9" x="120" y="150" width="160" height="60" rx="11"/><text class="code" x="128" y="164">FA_HX16_1N9</text><circle class="tagB" cx="266" cy="164" r="8"/><text class="tagT" x="266" y="167">К</text><text class="nm" x="200" y="182">Гексадеценовая</text><text class="nm" x="200" y="197">кислота C16:1ω9</text></g>
<g><rect class="cyc" data-node-id="oleic" x="340" y="150" width="160" height="60" rx="11"/><text class="code" x="348" y="164">FA_OLE</text><circle class="tagB" cx="486" cy="164" r="8"/><text class="tagT" x="486" y="167">К</text><text class="nm" x="420" y="186">Олеиновая кислота</text></g>
<g><rect class="cyc" data-node-id="nervonic" x="560" y="150" width="160" height="60" rx="11"/><text class="code" x="568" y="164">FA_NERV</text><circle class="tagB" cx="706" cy="164" r="8"/><text class="tagT" x="706" y="167">К</text><text class="nm" x="640" y="182">Селахолевая</text><text class="nm" x="640" y="197">(нервоновая)</text></g>
<g><rect class="cyc" data-node-id="mead" x="780" y="150" width="160" height="60" rx="11"/><text class="code" x="788" y="164">FA_MEAD</text><circle class="tagB" cx="926" cy="164" r="8"/><text class="tagT" x="926" y="167">К</text><text class="nm" x="860" y="186">Мидовая кислота</text></g>
...
export default function Omega9MufaSVG(props: PathwaySchemeProps) {
