...
/**
 * Omega3PufaSVG — статическая SVG-карточка «Омега-3 ПНЖК (АЛК, ЭПК, ДГК)» (omega3_pufa).
...
<text class="ttl" x="30" y="40">Омега-3 ПНЖК (АЛК, ЭПК, ДГК)</text>
<text class="sub" x="30" y="60">omega3_pufa · связи по слою зависимостей · М=моча К=кровь · severity не начисляется</text>
<g class="graph" transform="translate(110 0)">
<line class="ar" data-edge-id="DEP_059" data-from="ala" data-to="epa" data-direction="→" data-relation="реакция" x1="284.0" y1="180.0" x2="336.0" y2="180.0" marker-end="url(#__ARROW_ID__)"/>
<line class="ar" data-edge-id="DEP_060" data-from="epa" data-to="dha" data-direction="→" data-relation="реакция" x1="504.0" y1="180.0" x2="556.0" y2="180.0" marker-end="url(#__ARROW_ID__)"/>
<g><rect class="cyc" data-node-id="ala" x="120" y="150" width="160" height="60" rx="11"/><text class="code" x="128" y="164">FA_ALA</text><circle class="tagB" cx="266" cy="164" r="8"/><text class="tagT" x="266" y="167">К</text><text class="nm" x="200" y="186">Альфа-линоленовая</text></g>
<g><rect class="cyc" data-node-id="epa" x="340" y="150" width="160" height="60" rx="11"/><text class="code" x="348" y="164">FA_EPA</text><circle class="tagB" cx="486" cy="164" r="8"/><text class="tagT" x="486" y="167">К</text><text class="nm" x="420" y="186">Эйкозапентаеновая</text></g>
<g><rect class="cyc" data-node-id="dha" x="560" y="150" width="160" height="60" rx="11"/><text class="code" x="568" y="164">FA_DHA</text><circle class="tagB" cx="706" cy="164" r="8"/><text class="tagT" x="706" y="167">К</text><text class="nm" x="640" y="186">Докозагексаеновая</text></g>
</g>
...
export default function Omega3PufaSVG(props: PathwaySchemeProps) {
