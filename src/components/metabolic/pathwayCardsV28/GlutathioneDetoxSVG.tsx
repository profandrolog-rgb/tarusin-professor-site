...
/**
 * GlutathioneDetoxSVG — статическая SVG-карточка «γ-Глутамильный цикл и глутатион» (glutathione_detox).
...
<text class="ttl" x="30" y="40">γ-Глутамильный цикл и глутатион</text>
<text class="sub" x="30" y="60">glutathione_detox · связи по слою зависимостей · М=моча К=кровь · severity не начисляется</text>
<g class="graph" transform="translate(220 0)">
<g><rect class="ctx" data-node-id="hydroxybutyrate_2" x="120" y="150" width="160" height="60" rx="11"/><text class="code" x="128" y="164">2HB</text><circle class="tagU" cx="266" cy="164" r="8"/><text class="tagT" x="266" y="167">М</text><text class="nm" x="200" y="186">2-Гидроксимасляная</text></g>
<g><rect class="cyc" data-node-id="pyroglutamate" x="340" y="150" width="160" height="60" rx="11"/><text class="code" x="348" y="164">PYROGLU</text><circle class="tagU" cx="486" cy="164" r="8"/><text class="tagT" x="486" y="167">М</text><text class="nm" x="420" y="182">Пироглутаминовая</text><text class="nm" x="420" y="197">кислота</text></g>
</g>
...
export default function GlutathioneDetoxSVG(props: PathwaySchemeProps) {
