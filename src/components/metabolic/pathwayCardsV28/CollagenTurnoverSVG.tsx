...
/**
 * CollagenTurnoverSVG — статическая SVG-карточка «Коллагеновый обмен» (collagen_turnover).
...
<text class="ttl" x="30" y="40">Коллагеновый обмен</text>
<text class="sub" x="30" y="60">collagen_turnover · связи по слою зависимостей · М=моча К=кровь · severity не начисляется</text>
<g class="graph" transform="translate(110 0)">
<line class="ar" data-edge-id="DEP_049" data-from="proline" data-to="hydroxyproline_4" data-direction="→" data-relation="реакция" x1="284.0" y1="180.0" x2="556.0" y2="180.0" marker-end="url(#__ARROW_ID__)"/>
<g><rect class="cyc" data-node-id="proline" x="120" y="150" width="160" height="60" rx="11"/><text class="code" x="128" y="164">AA_PRO_PL</text><circle class="tagB" cx="266" cy="164" r="8"/><text class="tagT" x="266" y="167">К</text><text class="nm" x="200" y="186">Пролин</text></g>
<g><rect class="ctx" data-node-id="hydroxylysine" x="340" y="150" width="160" height="60" rx="11"/><text class="code" x="348" y="164">AA_HYL_PL</text><circle class="tagB" cx="486" cy="164" r="8"/><text class="tagT" x="486" y="167">К</text><text class="nm" x="420" y="186">Гидроксилизин</text></g>
<g><rect class="ctx" data-node-id="hydroxyproline_4" x="560" y="150" width="160" height="60" rx="11"/><text class="code" x="568" y="164">AA_HYP4_PL</text><circle class="tagB" cx="706" cy="164" r="8"/><text class="tagT" x="706" y="167">К</text><text class="nm" x="640" y="186">4-Гидроксипролин</text></g>
</g>
...
export default function CollagenTurnoverSVG(props: PathwaySchemeProps) {
