...
/**
 * GlycineSerineThreonineSVG — статическая SVG-карточка «Обмен глицина, серина и треонина» (glycine_serine_threonine).
...
<text class="ttl" x="30" y="40">Обмен глицина, серина и треонина</text>
<text class="sub" x="30" y="60">glycine_serine_threonine · связи по слою зависимостей · М=моча К=кровь · severity не начисляется</text>
<g class="graph" transform="translate(110 0)">
<line class="ar" data-edge-id="DEP_053" data-from="threonine" data-to="glycine" data-direction="→" data-relation="реакция" x1="284.0" y1="180.0" x2="556.0" y2="180.0" marker-end="url(#__ARROW_ID__)"/>
<line class="ar" data-edge-id="DEP_054" data-from="serine" data-to="glycine" data-direction="⇄" data-relation="реакция" x1="504.0" y1="180.0" x2="556.0" y2="180.0" marker-end="url(#__ARROW_ID__)" marker-start="url(#__ARROW_ID__)"/>
<g><rect class="cyc" data-node-id="threonine" x="120" y="150" width="160" height="60" rx="11"/><text class="code" x="128" y="164">AA_THR_PL</text><circle class="tagB" cx="266" cy="164" r="8"/><text class="tagT" x="266" y="167">К</text><text class="nm" x="200" y="186">Треонин</text></g>
<g><rect class="cyc" data-node-id="serine" x="340" y="150" width="160" height="60" rx="11"/><text class="code" x="348" y="164">AA_SER_PL</text><circle class="tagB" cx="486" cy="164" r="8"/><text class="tagT" x="486" y="167">К</text><text class="nm" x="420" y="186">Серин</text></g>
<g><rect class="cyc" data-node-id="glycine" x="560" y="150" width="160" height="60" rx="11"/><text class="code" x="568" y="164">AA_GLY_PL</text><circle class="tagB" cx="706" cy="164" r="8"/><text class="tagT" x="706" y="167">К</text><text class="nm" x="640" y="186">Глицин</text></g>
</g>
...
export default function GlycineSerineThreonineSVG(props: PathwaySchemeProps) {
