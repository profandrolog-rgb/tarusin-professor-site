...
/**
 * GlycerophospholipidAminesSVG — статическая SVG-карточка «Аминоспирты глицерофосфолипидов» (glycerophospholipid_amines).
...
<text class="ttl" x="30" y="40">Аминоспирты глицерофосфолипидов</text>
<text class="sub" x="30" y="60">glycerophospholipid_amines · связи по слою зависимостей · М=моча К=кровь · severity не начисляется</text>
<g class="graph" transform="translate(110 0)">
<line class="ar" data-edge-id="DEP_055" data-from="phosphoserine" data-to="phosphoethanolamine" data-direction="→" data-relation="реакция" x1="284.0" y1="180.0" x2="336.0" y2="180.0" marker-end="url(#__ARROW_ID__)"/>
<line class="ar" data-edge-id="DEP_056" data-from="phosphoethanolamine" data-to="ethanolamine" data-direction="→" data-relation="реакция" x1="504.0" y1="180.0" x2="556.0" y2="180.0" marker-end="url(#__ARROW_ID__)"/>
<g><rect class="cyc" data-node-id="phosphoserine" x="120" y="150" width="160" height="60" rx="11"/><text class="code" x="128" y="164">AA_PSER_PL</text><circle class="tagB" cx="266" cy="164" r="8"/><text class="tagT" x="266" y="167">К</text><text class="nm" x="200" y="186">Фосфосерин</text></g>
<g><rect class="cyc" data-node-id="phosphoethanolamine" x="340" y="150" width="160" height="60" rx="11"/><text class="code" x="348" y="164">AA_PETN_PL</text><circle class="tagB" cx="486" cy="164" r="8"/><text class="tagT" x="486" y="167">К</text><text class="nm" x="420" y="186">Фосфоэтаноламин</text></g>
<g><rect class="cyc" data-node-id="ethanolamine" x="560" y="150" width="160" height="60" rx="11"/><text class="code" x="568" y="164">AA_ETN_PL</text><circle class="tagB" cx="706" cy="164" r="8"/><text class="tagT" x="706" y="167">К</text><text class="nm" x="640" y="186">Этаноламин</text></g>
</g>
...
export default function GlycerophospholipidAminesSVG(props: PathwaySchemeProps) {
