...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: TelegramIcon, href: "https://t.me/Professor_DI", label: "Telegram" },
    { icon: InstagramIcon, href: "https://www.instagram.com/androlog_di", label: "Instagram" },
    { icon: FacebookIcon, href: "https://www.facebook.com/tarusindi", label: "Facebook" },
    { icon: DzenIcon, href: "https://dzen.ru/boymanblog", label: "Дзен" },
    { icon: WhatsAppIcon, href: "https://wa.me/79778075544", label: "WhatsApp" },
  ];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-background/70 text-sm mb-4">
              Член-корреспондент РАЕН, профессор, доктор медицинских наук, врач высшей категории. 
              Основатель детской андрологии в России. Более 42 лет опыта на страже мужского здоровья.
            </p>
            {/* Social Links */}
