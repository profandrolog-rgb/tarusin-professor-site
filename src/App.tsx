...
export const routes: RouteRecord[] = [
  {
    ...
    children: [
      ...
      { path: "admin/patients/new", element: <AdminPatientForm mode="create" />, entry: "src/pages/AdminPatientForm.tsx" },
      { path: "admin/patients/:id/edit", element: <AdminPatientForm mode="edit" />, entry: "src/pages/AdminPatientForm.tsx" },
