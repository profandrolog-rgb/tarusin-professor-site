...
const stats = [
  { icon: Presentation, value: "860+", label: "Выступлений и докладов" },
  { icon: Globe, value: "15+", label: "Стран для мастер-классов" },
  { icon: Users, value: "600+", label: "Обученных врачей" },
  { icon: Award, value: "12+", label: "Лет школы ДУА" },
];
...
const Masterclasses = () => {
  return (
    <div className="min-h-screen bg-background">
      <PageMeta
        title="Мастер-классы и выступления — Проф. Тарусин Д.И."
        description="Мастер-классы, выступления и образовательные программы профессора Тарусина. Более 860 докладов, обучение врачей из 15+ стран."
        path="/masterclasses"
      />
      ...
      <header className="bg-primary text-primary-foreground py-12 md:py-20">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-4">Мастер-классы и выступления</h1>
          <p className="text-lg md:text-xl text-primary-foreground/80 max-w-2xl">
            Образовательная деятельность, лекции и международные выступления профессора Тарусина
          </p>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-12 md:py-16">
          ...
          <CardContent className="p-6 md:p-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-background rounded-lg p-4 border border-border">
                <Badge className={typeColors["Авторский проект"]}>Авторский проект</Badge>
                <h3 className="font-semibold text-foreground mt-2 mb-1">Лабиринты детской урологии</h3>
                <p className="text-sm text-muted-foreground">
                  Образовательный проект для врачей с 2024 года. Систематизация 42-летнего опыта 
                  в формате практических разборов и клинических рекомендаций.
                </p>
              </div>
              <div className="bg-background rounded-lg p-4 border border-border">
                <Badge className={typeColors["Школа"]}>Ежегодная</Badge>
                <h3 className="font-semibold text-foreground mt-2 mb-1">Всероссийская школа по ДУА</h3>
                <p className="text-sm text-muted-foreground">
                  Сопредседатель с 2012 года. Ежегодная программа подготовки врачей-специалистов 
                  по детской урологии-андрологии со всей России.
                </p>
              </div>
            </div>
          </CardContent>
        ...
        {/* Timeline */}
        <h2 className="text-2xl font-bold text-foreground mb-8 text-center">Архив выступлений</h2>
        ...
        <Card className="mt-12 bg-primary text-primary-foreground">
          <CardContent className="p-8 md:p-12 text-center">
            ...
            <p className="text-primary-foreground/80 max-w-2xl mx-auto mb-6">
              Профессор Тарусин открыт к приглашениям на конференции, мастер-классы 
              и образовательные мероприятия. Для организации выступления свяжитесь 
