...
const pressArticles = [
  {
    title: "Пусть он станет папой",
    description: "О репродуктивном здоровье мальчиков",
    source: "Новые Известия",
    url: "https://newizv.ru/news/2009-06-06/pust-on-stanet-papoy-110359",
    year: "2009"
  },
  {
    title: "Подростки и онкология: важность ранней диагностики",
    description: "УЗИ молочных желез и профилактика",
    source: "Агентство социальной информации",
    url: "https://asi.org.ru/news/2019/04/04/podrostki-onkologiya/",
    year: "2019"
  },
  {
    title: "Московская медицина",
    description: "Материал в издании НИИ организации здравоохранения",
    source: "НИИОЗ",
    url: "https://niioz.ru/upload/iblock/fc0/fc09f5a26ec81a23de29f7402ac03df2.pdf",
    type: "PDF"
  },
  {
    title: "Чётки-пацан",
    description: "Дискуссия об орхидометрах и диагностике",
    source: "Vademecum",
    url: "https://vademec.ru/article/chetki_patsan/"
  }
];
...
const tvProjects = [
  {
    ...
    videoUrl: "https://www.youtube.com/watch?v=f1O-1x4JPYs",
    infoUrl: "https://www.wuor.ru/news/17827-zhenskii_vopros_gost_efira_dmitrii_tarusin/",
  ...
  },
  {
    ...
    videoUrl: "https://www.youtube.com/watch?v=cVfXJrElYps",
    thumbnail: "https://img.youtube.com/vi/cVfXJrElYps/maxresdefault.jpg"
  },
  {
    title: "Ранняя диагностика нарушений репродуктивного здоровья мальчиков",
    description: "Образовательное видео для специалистов и родителей",
    videoUrl: "https://www.youtube.com/watch?v=jO2ikp7Aenc",
    thumbnail: "https://img.youtube.com/vi/jO2ikp7Aenc/maxresdefault.jpg"
  }
];
...
const podcasts = [
  {
    ...
    description: "Комментарии уролога и психолога о детской мастурбации",
    source: "Подкаст «Я просто спросить» — Mel.fm",
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="bg-primary text-primary-foreground py-12 md:py-20">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-4">СМИ, ТВ и подкасты</h1>
          <p className="text-lg md:text-xl text-primary-foreground/80 max-w-2xl">
            Публикации в прессе, телевизионные проекты и подкасты с участием профессора Тарусина
          </p>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-12 md:py-16">
        ...
        <section className="mb-16">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-foreground">Газеты и журналы</h2>
          </div>
              ...
              <Card key={index} className="group hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    {article.type && (
                      <span className="text-xs bg-secondary px-2 py-0.5 rounded">{article.type}</span>
                    )}
                  </div>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-foreground">ТВ и видеопроекты</h2>
          </div>
