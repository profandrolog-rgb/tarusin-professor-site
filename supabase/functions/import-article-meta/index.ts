...
Поля:
- title: короткий заголовок (до 80 символов, законченная фраза, на русском, без кавычек и без обрыва на полуслове; если не помещается — переформулируй короче)
- slug: латиница, нижний регистр, дефисы, без диакритики, до 60 символов, транслитерируй с русского
- excerpt: краткая аннотация 1-2 предложения, законченная фраза (до 200 символов; если не помещается — переформулируй короче, не отрезай на полуслове)
