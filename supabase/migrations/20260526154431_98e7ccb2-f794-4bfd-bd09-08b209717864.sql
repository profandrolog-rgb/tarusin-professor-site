CREATE OR REPLACE FUNCTION public.analytics_irt_dashboard(_from date, _to date, _status text DEFAULT 'issued'::text, _doctor text DEFAULT 'all'::text, _ttl_minutes integer DEFAULT 60)
 RETURNS jsonb
 LANGUAGE plpgsql
